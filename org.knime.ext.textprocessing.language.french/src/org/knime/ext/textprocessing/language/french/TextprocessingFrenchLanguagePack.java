package org.knime.ext.textprocessing.language.french;
 ...
 * @since 3.4
 */
public class TextprocessingFrenchLanguagePack extends AbstractUIPlugin {
    
    private static final NodeLogger LOGGER = NodeLogger.getLogger(TextprocessingFrenchLanguagePack.class);

    // The plug-in ID
    public static final String PLUGIN_ID = "org.knime.ext.textprocessing.language.french";

    private static final String ASSETS_PLUGIN_ID = "org.knime.ext.textprocessing.language.french.assets";

    // The shared instance
    private static TextprocessingFrenchLanguagePack plugin;

    /**
     * The constructor
     */
    public TextprocessingFrenchLanguagePack() {
        plugin = this;
    }
     ...
     */
    public static TextprocessingFrenchLanguagePack getDefault() {
        return plugin;
    }
    ...
    public static File resolvePath(final String relativePath) {
        final var myself = FrameworkUtil.getBundle(TextprocessingFrenchLanguagePack.class);
