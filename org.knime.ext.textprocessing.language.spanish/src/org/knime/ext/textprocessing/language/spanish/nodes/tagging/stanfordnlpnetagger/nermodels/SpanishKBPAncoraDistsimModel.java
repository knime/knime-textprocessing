 ...
 * the "Spanish KBP Ancora distsim" named-entity recognition model.
 *
 * @author Julian Bunzel, KNIME.com GmbH, Berlin, Germany
 */
public class SpanishKBPAncoraDistsimModel implements StanfordTaggerModel {

	/**
	 * This map stores tags used by the Spanish Stanford ner models and maps
	 * them to the tag naming used by KNIME.
	 */
	...
	private static final String MODELNAME = "Spanish KBP ancora distsim";

	private static final String MODELPATH = "models/stanfordmodels/nermodels/spanish.kbp.ancora.distsim.s512.crf.ser.gz";
