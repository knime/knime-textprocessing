 ...
 */
package org.knime.ext.textprocessing.language.spanish.nodes.tagging.stanfordnlpnetagger.nermodels;
...
/**
 * This class implements the {@link StanfordTaggerModel} interface to provide the "Spanish Ancora distsim" named-entity
 * recognition model.
 *
 * @author Julian Bunzel, KNIME.com GmbH, Berlin, Germany
 */
public class SpanishAncoraDistsimModel implements StanfordTaggerModel {

    /**
     * This map stores tags used by the Spanish Stanford ner models and maps them to the tag naming used by KNIME.
     */
    ...
    private static final String MODELNAME = "Spanish ancora distsim";

    private static final String MODELPATH = "models/stanfordmodels/nermodels/spanish.ancora.distsim.s512.crf.ser.gz";
