package org.knime.ext.textprocessing.language.spanish;
...
public class TextprocessingSpanishLanguagePack extends AbstractUIPlugin {
    ...
    private static final String MODELS_PLUGIN_ID = "org.knime.ext.textprocessing.language.spanish.models";
     ...
     * The constructor
     */
    public TextprocessingSpanishLanguagePack() {
        plugin = this;
    }
     ...
     */
    public static TextprocessingSpanishLanguagePack getDefault() {
        return plugin;
    }
