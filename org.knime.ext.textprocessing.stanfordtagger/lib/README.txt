Stanford POS Tagger, v. 3.0.1 - 2011-04-17
...
tagger, and we provide models for some other languages. The tagger can
be retrained on other languages based on POS-annotated training text.
