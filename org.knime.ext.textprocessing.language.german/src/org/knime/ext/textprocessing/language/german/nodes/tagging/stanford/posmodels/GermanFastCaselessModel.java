...
/**
 * This class implements the {@link StanfordTaggerModel} interface to provide the "German fast caseless"
 * part-of-speech model.
 *
 * @author Julian Bunzel, KNIME AG, Berlin, Germany
 * @since 3.6
 */
public class GermanFastCaselessModel implements StanfordTaggerModel {

    private static final String MODELNAME = "German fast caseless";
