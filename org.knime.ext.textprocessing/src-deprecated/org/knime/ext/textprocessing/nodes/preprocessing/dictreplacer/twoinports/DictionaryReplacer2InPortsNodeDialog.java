 ...
 * @deprecated use {@link DictionaryReplacer2InPortsNodeDialog2} instead.
 */
@Deprecated
public class DictionaryReplacer2InPortsNodeDialog extends
        PreprocessingNodeSettingsPane {
    ...
    public static final SettingsModelString getReplaceColumnModel() {
        return new SettingsModelString(
                DictionaryReplacer2InPortsConfigKeys.CFGKEY_KEYCOLUMN, "");
    }
    ...
    public static final SettingsModelString getReplacementColumnModel() {
        return new SettingsModelString(
                DictionaryReplacer2InPortsConfigKeys.CFGKEY_VALUECOLUMN, "");
    }

    /**
     * Constructor of <code>DictionaryReplacer2InPortsNodeDialog</code>.
     */
    @SuppressWarnings("unchecked")
    public DictionaryReplacer2InPortsNodeDialog() {
        super();
        ...
        addDialogComponent(new DialogComponentColumnNameSelection(
                getReplaceColumnModel(),
                "Column containing the strings to replace", 1, true,
                StringValue.class));

        addDialogComponent(new DialogComponentColumnNameSelection(
                getReplacementColumnModel(),
                "Column containing the replacement strings", 1, true,
                StringValue.class));
    }
}
