...
import org.knime.ext.textprocessing.data.PharmaDefaultTag;
 ...
 */
@Deprecated
public class PharmaDefaultTagFilterNodeDialog extends TagFilterNodeDialog {
    ...
    protected Set<Tag> getTags() {
        return TagFactory.getInstance().getTagSetByType(
                PharmaDefaultTag.TAG_TYPE).getTags();
    }
}
