...
public final class StopWordFilterConfigKeys2 {
    ...
    public static final String CFGKEY_FILE = "Stop word file";

    /** Config Key for the activation of case sensitivity. */
    public static final String CFGKEY_CASE_SENSITIVE = "Case sensitive";

    /** Config Key for the "use build in list" flag. */
    public static final String CFGKEY_USE_BUILDIN_LIST = "Use built-in list";

    /** Config Key for the selected build in list. */
    public static final String CFGKEY_BUILDIN_LIST = "Built-in list";
}
