...
public class StanfordNlpNeTaggerNodeModel extends StreamableTaggerNodeModel {
    ...
    /**
     * The constructor of the {@code StanfordNlpNeTaggerNodeModel}, which creates a node with two inports (
     ...
     */
    public StanfordNlpNeTaggerNodeModel() {
        super(
    ...
    protected void checkInputPortSpecs(final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        if (inSpecs[1] != null) {
            ...
            if (tokenizer != null) {
                ...
                if (!getTokenizerName().equals(PreferenceUtil.getDefaultTokenizer())) {
                    setWarningMessage(
