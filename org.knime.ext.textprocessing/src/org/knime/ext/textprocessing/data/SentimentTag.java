 ...
 *
 * History
 *   25.06.2014 (Kilian Thiel): created
 */
...
/**
 * This enum contains the sentiment tag set. To create a valid {@link org.knime.ext.textprocessing.data.Tag} instance
 * use {@link org.knime.ext.textprocessing.data.SentimentTag#getTag()}, i.e: <br>
 * <br>
 * {@code Tag t = SentimentTag.POSITIVE.getTag();}
 *
 * @author Kilian Thiel, KNIME.com GmbH, Berlin, Germany
 * @since 2.10
 */
public enum SentimentTag implements TagBuilder {
    ...
    /**
     * The constant for Sentiment tag types.
     */
    public static final String TAG_TYPE = "SENTIMENT";

    /**
     * Creates new instance of {@code SentimentTag}.
     */
    ...
    /**
     * @return The {@link org.knime.ext.textprocessing.data.Tag} corresponding to the specified {@code SentimentTag}.
     */
    public Tag getTag() {
        return m_tag;
    }
    ...
    public List<String> asStringList() {
        Enum<SentimentTag>[] values = values();
    ...
    public static Tag stringToTag(final String str) {
        for (SentimentTag pos : values()) {
            if (pos.getTag().getTagValue().equals(str)) {
                return pos.getTag();
            }
        }
        return SentimentTag.UNKNOWN.getTag();
    }
    ...
    public Tag buildTag(final String value) {
        return SentimentTag.stringToTag(value);
    }

    /**
     * @return The default "UNKNOWN" {@code SentimentTag} as {@code TagBuilder}.
     */
    public static TagBuilder getDefault() {
        return SentimentTag.UNKNOWN;
    }
