...
public final class TaggedValueMetaDataExtension implements DataColumnMetaDataExtension<TaggedValueMetaData> {
    ...
    @Override
    public DataColumnMetaDataCreator<TaggedValueMetaData> create() {
        return new TaggedValueMetaDataCreator();
    }

    @Override
    public DataColumnMetaDataSerializer<TaggedValueMetaData> createSerializer() {
        return new TaggedValueMetaDataSerializer();
    }
