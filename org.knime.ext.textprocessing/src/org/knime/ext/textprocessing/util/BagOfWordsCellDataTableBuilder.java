 ...
 */
public class BagOfWordsCellDataTableBuilder extends BagOfWordsDataTableBuilder {
     ...
     * {@inheritDoc}
     * 
     * This method creates a factory for <code>DocumentCell</code>s.
     */
    @Override
    ...
    protected boolean validateDocumentCellType(final DataCell documentCell) {
        if (documentCell instanceof DocumentCell) {
            return true;
        }
        return false;
    }    
