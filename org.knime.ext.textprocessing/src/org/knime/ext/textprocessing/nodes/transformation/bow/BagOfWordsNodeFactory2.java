...
public class BagOfWordsNodeFactory2 extends NodeFactory<BagOfWordsNodeModel2> implements NodeDialogFactory, KaiNodeInterfaceFactory {
     ...
     */
    @Override
    public BagOfWordsNodeModel2 createNodeModel() {
        return new BagOfWordsNodeModel2();
    }
     ...
     */
    @Override
    public NodeView<BagOfWordsNodeModel2> createNodeView(final int index, final BagOfWordsNodeModel2 model) {
        return null;
    }
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, BagOfWordsNodeFactory2Parameters.class);
    }
    ...
    public KaiNodeInterface createKaiNodeInterface() {
        return new DefaultKaiNodeInterface(Map.of(SettingsType.MODEL, BagOfWordsNodeFactory2Parameters.class));
    }
}
