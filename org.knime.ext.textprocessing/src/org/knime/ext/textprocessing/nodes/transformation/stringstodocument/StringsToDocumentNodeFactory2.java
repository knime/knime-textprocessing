...
public class StringsToDocumentNodeFactory2 extends NodeFactory<StringsToDocumentNodeModel2> {
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new StringsToDocumentNodeDialog2();
    }
     ...
     */
    @Override
    public StringsToDocumentNodeModel2 createNodeModel() {
        return new StringsToDocumentNodeModel2();
    }
     ...
     */
    @Override
    public NodeView<StringsToDocumentNodeModel2> createNodeView(final int index,
        final StringsToDocumentNodeModel2 model) {
        return null;
    }
