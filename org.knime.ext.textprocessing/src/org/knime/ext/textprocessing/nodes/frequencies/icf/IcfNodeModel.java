...
/**
 * The model of the ICF-Node, specifying the proper cell factory
 * {@link org.knime.ext.textprocessing.nodes.frequencies.icf.IcfCellFactory}.
 * 
 * @author Kilian Thiel, University of Konstanz
 */
public class IcfNodeModel extends FrequencyNodeModel {

    /**
     * Creates a new instance of <code>IcfNodeModel</code>.
     */
    public IcfNodeModel() {
        super();
    }
    ...
    protected void initCellFactory(final BufferedDataTable inData,
        ...
        m_cellFac = new IcfCellFactory(getDocumentColIndex(), getTermColIndex(),
                inData, exec);
    }
        ...
        DataColumnSpec freq = 
            new DataColumnSpecCreator(
                    DataTableSpec.getUniqueColumnName(
                            inDataSpec, IcfCellFactory.COLNAME), 
