...
public final class TikaParserNodeFactory extends NodeFactory<TikaParserNodeModel> {
     ...
     */
    @Override
    public TikaParserNodeModel createNodeModel() {
        return new TikaParserNodeModel();
    }
     ...
     */
    @Override
    public NodeView<TikaParserNodeModel> createNodeView(final int viewIndex, final TikaParserNodeModel nodeModel) {
        return null;
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new TikaParserNodeDialog();
    }
