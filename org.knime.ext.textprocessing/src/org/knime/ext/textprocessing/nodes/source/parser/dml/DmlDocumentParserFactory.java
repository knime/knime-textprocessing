...
/**
 * Factory that creates instances of {@link DmlDocumentParser}.
 *
 * @author Kilian Thiel, KNIME.com, Zurich, Switzerland
 * @since 2.9
 */
public class DmlDocumentParserFactory implements DocumentParserFactory {
    ...
    public DocumentParser createParser(final String tokenizerName) throws InstantiationException {
        return new DmlDocumentParser(tokenizerName);
    }
}
