...
/**
 * Factory that creates instances of {@link PDFDocumentParser}.
 *
 * @author Kilian Thiel, KNIME AG, Zurich, Switzerland
 * @since 2.9
 */
public class PDFDocumentParserFactory implements DocumentParserFactory {
    /**
     * {@inheritDoc}
     * @since 3.3
     */
    ...
    public DocumentParser createParser(final String tokenizerName) throws InstantiationException {
        return new PDFDocumentParser(tokenizerName);
    }
}
