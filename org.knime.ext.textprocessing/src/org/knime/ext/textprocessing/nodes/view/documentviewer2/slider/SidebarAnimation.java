 ...
 */
class SidebarAnimation extends Animation {
     ...
     * @param durationMs
     */
    public SidebarAnimation(final SidebarSection sidebarSection, final int durationMs) {
        super(durationMs);
    ...
    @Override
    protected void render(final int val) {
        sideBarSection.setMaximumSize(new Dimension(Integer.MAX_VALUE, val));
        sideBarSection.contentPane.setVisible(true);
