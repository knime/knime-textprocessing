...
/**
 * This exception is thrown if a tokenizer is not installed.
 *
...
public class MissingTokenizerException extends InvalidSettingsException {
     ...
     */
    public MissingTokenizerException(final String name) {
        super("Tokenizer \"" + name + "\" could not be found, due to missing language extension!\n"
