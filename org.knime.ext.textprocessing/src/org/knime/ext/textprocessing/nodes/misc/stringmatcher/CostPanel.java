...
public class CostPanel extends JPanel {
  ...
  public CostPanel() {
          ...
          m_wd = new SettingsModelIntegerBounded(
                    StringMatcherNodeModel.CFG_WD, 1, 0, Integer.MAX_VALUE);
          m_wi = new SettingsModelIntegerBounded(
                    StringMatcherNodeModel.CFG_WI, 1, 0, Integer.MAX_VALUE);
          m_wc = new SettingsModelIntegerBounded(
                    StringMatcherNodeModel.CFG_WC, 1, 0, Integer.MAX_VALUE);
          m_ws = new SettingsModelIntegerBounded(
                    StringMatcherNodeModel.CFG_WS, 1, 0, Integer.MAX_VALUE);
                          
        final DialogComponentNumber wd = 
             new DialogComponentNumber(m_wd,
                         StringMatcherNodeModel.CFG_WD, 1);
        
        final DialogComponentNumber wi = 
             new DialogComponentNumber(m_wi,
                         StringMatcherNodeModel.CFG_WI, 1);
       
        final DialogComponentNumber wc = 
             new DialogComponentNumber(m_wc,
                          StringMatcherNodeModel.CFG_WC, 1);
       
        final DialogComponentNumber ws = 
             new DialogComponentNumber(m_ws,
                          StringMatcherNodeModel.CFG_WS, 1);
