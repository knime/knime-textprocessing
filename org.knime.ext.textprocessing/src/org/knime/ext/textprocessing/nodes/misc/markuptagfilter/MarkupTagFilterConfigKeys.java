 ...
 */
final class MarkupTagFilterConfigKeys {

    private MarkupTagFilterConfigKeys() {
        /* empty constructor */ }

    /**
     * The configuration key for the selected column names.
     */
    static final String COLUMN_NAMES = "Column Names";

    /**
     * The configuration key for the specified column appending.
     */
    static final String APPEND_COLUMNS = "Append Columns";
