...
/**
 * This class implements the {@link StanfordTaggerModel} interface to provide the "English 7 class no distsim"
 * named-entity recognition model.
 *
 * @author Julian Bunzel, KNIME.com GmbH, Berlin, Germany
 */
public class English7ClassesNoDistsimModel implements StanfordTaggerModel {

    private static final String MODELNAME = "English 7 classes no distsim";

    private static final String MODELPATH = "stanfordmodels/nermodels/english.muc.7class.nodistsim.crf.ser.gz";
