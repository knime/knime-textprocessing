 ...
 * @since 3.5
 */
final class DictionaryTaggerMultiColumnConfigKeys {

    private DictionaryTaggerMultiColumnConfigKeys() {
    }
    ...
    static final String CFGKEY_CASESENSITIVE = "CaseSensitive";

    static final String CFGKEY_TAGTYPE = "TagType";

    static final String CFGKEY_TAGVALUE = "TagValue";
}
