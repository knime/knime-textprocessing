...
/**
 * This class implements the {@link StanfordTaggerModel} interface to provide the "English 4 class caseless distsim"
 * named-entity recognition model.
 *
 * @author Julian Bunzel, KNIME.com GmbH, Berlin, Germany
 */
public class English4ClassesCaselessDistsimModel implements StanfordTaggerModel {

    private static final String MODELNAME = "English 4 classes caseless distsim";

    private static final String MODELPATH = "stanfordmodels/nermodels/english.conll.4class.caseless.distsim.crf.ser.gz";
