...
/**
 * Provides the configuration keys for multi tagger nodes.
 *
 * @author Julian Bunzel, University of Konstanz
 * @since 3.6
 */
public final class MultiTaggerConfigKeys {
     ...
     */
    public static final String CFGKEY_COLUMNNAME = "ColumnName";
