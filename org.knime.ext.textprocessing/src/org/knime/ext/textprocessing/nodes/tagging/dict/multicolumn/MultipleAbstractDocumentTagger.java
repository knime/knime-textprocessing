...
import org.knime.ext.textprocessing.nodes.tagging.IndexRange;
 ...
 * {@link org.knime.ext.textprocessing.nodes.tagging.dict.multicolumn.MultipleAbstractDocumentTagger#tagEntities(Sentence)} and on the other hand
 ...
 * {@link org.knime.ext.textprocessing.nodes.tagging.dict.multicolumn.MultipleAbstractDocumentTagger#getTags(String)} which is called by
 ...
 */
public abstract class MultipleAbstractDocumentTagger implements DocumentTagger {
    /**
    ...
    /**
     * The list of unmodifiable flags.
     */
    protected List<Boolean> m_setNeUnmodifiable;

    /**
     * The list of case sensitive flags.
     */
    protected List<Boolean> m_caseSensitive;

    /**
     * The list of exact match flags.
     */
    protected List<Boolean> m_exactMatch;
     ...
     * @since 3.3
     */
    public MultipleAbstractDocumentTagger(final List<Tag> tags, final List<Boolean> setUnmodifiable,
        final List<Boolean> caseSensitive, final List<Boolean> exactMatch, final String tokenizerName) {
     ...
     */
    protected abstract List<Tag> getTags(final Tag tag);
