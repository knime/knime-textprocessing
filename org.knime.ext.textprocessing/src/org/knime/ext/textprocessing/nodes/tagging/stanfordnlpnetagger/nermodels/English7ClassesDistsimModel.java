...
/**
 * This class implements the {@link StanfordTaggerModel} interface to provide the "English 7 class distsim" named-entity
 * recognition model.
 *
 * @author Julian Bunzel, KNIME.com GmbH, Berlin, Germany
 */
public class English7ClassesDistsimModel implements StanfordTaggerModel {

    private static final String MODELNAME = "English 7 classes distsim";

    private static final String MODELPATH = "stanfordmodels/nermodels/english.muc.7class.distsim.crf.ser.gz";
