...
/**
 * This class implements the {@link StanfordTaggerModel} interface to provide the "English 3 class no distsim"
 * named-entity recognition model.
 *
 * @author Julian Bunzel, KNIME.com GmbH, Berlin, Germany
 */
public class English3ClassesNoDistsimModel implements StanfordTaggerModel {

    private static final String MODELNAME = "English 3 classes no distsim";

    private static final String MODELPATH = "stanfordmodels/nermodels/english.all.3class.nodistsim.crf.ser.gz";
