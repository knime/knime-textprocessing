...
/**
 * The configuration keys of the Stanford POS tagger node.
 *
 * @author Kilian Thiel, KNIME.com GmbH, Berlin, Germany
 * @since 3.5
 */
final class StanfordTaggerConfigKeys2 {

    private StanfordTaggerConfigKeys2() {
    }

    /**
     * The configuration key of tagger model to use.
     */
    static final String CFGKEY_MODEL = "Tagger Model";
}
