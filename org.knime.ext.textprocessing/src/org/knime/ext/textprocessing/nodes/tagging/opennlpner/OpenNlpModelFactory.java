...
public final class OpenNlpModelFactory {
    ...
    private OpenNlpModelFactory() {
        ...
        // LOCATION
        name = "Location";
        m = new OpenNlpModel(name, getModel(paths.getLocationNERModelFile()), 
                NamedEntityTag.LOCATION.toString());
        m_models.put(name, m);
        
        // ORGANIZATION
        name = "Organization";
        m = new OpenNlpModel(name, getModel(
                paths.getOrganizationNERModelFile()), 
        ...
        name = "Time";
        m = new OpenNlpModel(name, getModel(
                paths.getTimeNERModelFile()), 
                NamedEntityTag.TIME.toString());
        m_models.put(name, m);        
    }
    
    private static MaxentModel getModel(final String name) {
        try {
