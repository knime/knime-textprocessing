...
/**
 * This class implements the {@link StanfordTaggerModel} interface to provide the "English 4 class no distsim"
 * named-entity recognition model.
 *
 * @author Julian Bunzel, KNIME.com GmbH, Berlin, Germany
 */
public class English4ClassesNoDistsimModel implements StanfordTaggerModel {

    private static final String MODELNAME = "English 4 classes no distsim";

    private static final String MODELPATH = "stanfordmodels/nermodels/english.conll.4class.nodistsim.crf.ser.gz";
