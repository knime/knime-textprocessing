 ...
 */
public class StanfordNlpNeScorerNodeDialog extends DefaultNodeSettingsPane {

    /**
     * @return Returns the SettingsModelString for the document column.
     */
    public static final SettingsModelString createDocumentColumnModel() {
        return new SettingsModelString(StanfordNlpNeScorerConfigKeys.CFGKEY_DOC_COLUMN, "");
    }
    ...
    public StanfordNlpNeScorerNodeDialog() {
        super();
