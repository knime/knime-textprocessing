...
/**
 * This class implements the {@link StanfordTaggerModel} interface to provide the "English 3 class no wiki distsim"
 * named-entity recognition model.
 *
 * @author Julian Bunzel, KNIME.com GmbH, Berlin, Germany
 */
public class English3ClassesNoWikiCaselessDistsimModel implements StanfordTaggerModel {

    private static final String MODELNAME = "English 3 classes no wiki caseless distsim";
