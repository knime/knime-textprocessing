...
/**
 * The configuration keys of the OpenNLP NER tagger node.
 *
...
final class OpenNlpTaggerConfigKeys2 {
     ...
     */
    static final String CFGKEY_MODEL = "OPENNLP Model";

    /**
     * The configuration key for the dictionary flag.
     */
    static final String CFGKEY_USE_DICT = "Use Dict";

    /**
     * The configuration key for the dictionary file.
     */
    static final String CFGKEY_DICTFILE = "Dict File";
