...
class StanfordLemmatizerNodeDialog extends PreprocessingNodeSettingsPane2 {
     ...
     */
    public static SettingsModelBoolean getFailModel() {
        return new SettingsModelBoolean(StanfordLemmatizerConfigKeys.CFG_KEY_FAIL, StanfordLemmatizer.DEF_FAIL);
    }
