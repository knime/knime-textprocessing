...
public final class DocumentPreprocessor extends AbstractPreprocessor {
    ...
    private DataTableSpec createDataTableSpec() {
        ...
        DataColumnSpecCreator docsOrig =
    ...
    public DataTableSpec createDataTableSpec(final boolean appendIncomingDocument) {
        DataColumnSpecCreator docs = new DataColumnSpecCreator(BagOfWordsDataTableBuilder.DEF_DOCUMENT_COLNAME,
            m_docCellFac.getDataType());
        DataColumnSpecCreator origDoc = new DataColumnSpecCreator(BagOfWordsDataTableBuilder.DEF_ORIG_DOCUMENT_COLNAME,
            m_docCellFac.getDataType());
