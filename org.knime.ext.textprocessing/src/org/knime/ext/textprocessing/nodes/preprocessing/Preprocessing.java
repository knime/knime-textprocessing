...
/**
 * This interface has to be implemented by all preprocessing nodes
 * no matter if filter or modification nodes. 
 * The method {@link Preprocessing#preprocess(Term)} has to be implemented by 
 * all underlying classes and provide a certain preprocessing functionality. 
 * A stemmer node for instance has to stem the given term and return the 
 * stemmed one. If a preprocessing class filters out a given term, 
