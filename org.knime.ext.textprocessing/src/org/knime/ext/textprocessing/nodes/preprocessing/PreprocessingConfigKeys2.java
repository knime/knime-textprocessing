 ...
 * @since 3.1
 */
public final class PreprocessingConfigKeys2 {

    private PreprocessingConfigKeys2() { }
    ...
    public static final String CFG_KEY_PREPRO_UNMODIFIABLE = "Preprocess Unmodifiable";
}
