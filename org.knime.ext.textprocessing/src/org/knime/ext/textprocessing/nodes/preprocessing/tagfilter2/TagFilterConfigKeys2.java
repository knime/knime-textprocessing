 ...
 * @since 3.1
 */
public final class TagFilterConfigKeys2 {

    private TagFilterConfigKeys2() { }

    /**
     * The configuration key for tag type to filter.
     */
    public static final String CFGKEY_TAGTYPE = "Tag Type";
     ...
     */
    public static final String CFGKEY_VALIDTAGS = "Tags To Filter";

    /**
     * The configuration key for the include selected option.
     */
    public static final String CFGKEY_FILTER_MATCHING = "Include Selected";
}
