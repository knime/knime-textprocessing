 ...
 * @since 3.1
 */
public final class RegExFilterNodeModel2 extends StreamableFunctionPreprocessingNodeModel {

    /** The default regular expression (an empty string). */
    public static final String DEFAULT_REGEX = "";

    private SettingsModelString m_regExModel = RegExFilterNodeDialog2.getRegExModel();
    ...
    protected TermPreprocessing createPreprocessing() throws Exception {
        return new RegExFilter(m_regExModel.getStringValue());
    }
    ...
    protected void validateSettings(final NodeSettingsRO settings)
        ...
        try {
            ...
            throw new InvalidSettingsException("Specified pattern is not valid: \"" + inputPattern + "\"");
        }
    }
}
