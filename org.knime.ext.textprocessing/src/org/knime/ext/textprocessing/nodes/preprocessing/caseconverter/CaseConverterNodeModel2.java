 ...
 * @since 3.1
 */
public final class CaseConverterNodeModel2 extends StreamableFunctionPreprocessingNodeModel {

    private SettingsModelString m_caseModel = CaseConverterNodeDialog2.getCaseModel();
    ...
    protected TermPreprocessing createPreprocessing() throws Exception {
        return new CaseConverter(m_caseModel.getStringValue());
    }
