 ...
 * @since 3.1
 */
public final class PunctuationErasureNodeFactory2 extends NodeFactory<PunctuationErasureNodeModel2> {
    ...
    public PunctuationErasureNodeModel2 createNodeModel() {
        return new PunctuationErasureNodeModel2();
    }
     ...
     */
    @Override
    public NodeView<PunctuationErasureNodeModel2> createNodeView(final int viewIndex,
        final PunctuationErasureNodeModel2 nodeModel) {
        return null;
    }
