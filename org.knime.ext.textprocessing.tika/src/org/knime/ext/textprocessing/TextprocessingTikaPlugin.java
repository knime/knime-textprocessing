...
/**
 * The plugin class for the tika nodes.
 *
 * @author Magnus Gohm, KNIME AG, Konstanz, Germany
 */
public class TextprocessingTikaPlugin extends AbstractUIPlugin {
    // The shared instance.
    private static TextprocessingTikaPlugin plugin;

    /**
     * The constructor.
     */
    public TextprocessingTikaPlugin() {
        plugin = this;
    }
     ...
     */
    public static TextprocessingTikaPlugin getDefault() {
        return plugin;
    }
    ...
    public static ImageDescriptor getImageDescriptor(final String path) {
        return AbstractUIPlugin.imageDescriptorFromPlugin(
                "org.knime.ext.textprocessing.tika", path);
    }
    ...
    public static File resolvePath(final String relativePath) {
        Bundle myself = FrameworkUtil.getBundle(TextprocessingTikaPlugin.class);
        try {
            URL fileUrl = FileLocator.toFileURL(FileLocator.find(myself, new Path(relativePath), null));
            return new File(fileUrl.getPath());
        } catch (IOException ex) {
            NodeLogger.getLogger(TextprocessingTikaPlugin.class)
