...
import org.knime.ext.textprocessing.dl4j.settings.enumerate.SequenceLearningAlgorithm;
 ...
 */
public class Doc2VecLearningParametersComponentGroup extends AbstractGridBagDialogComponentGroup {
    ...
    private SettingsModelString m_sequenceAlgoSettings;
     ...
     * @param settings
     */
    public Doc2VecLearningParametersComponentGroup(final WordVectorParameterSettingsModels2 settings) {
        ...
        m_sequenceAlgoSettings = (SettingsModelString)settings.createParameter(WordVectorLearnerParameter.SEQUENCE_LEARNING_ALGO);
        ...
        addComboBoxRow(m_sequenceAlgoSettings, "Sequence Learning Algorithm",
            EnumUtils.getStringCollectionFromToString(SequenceLearningAlgorithm.values()));
