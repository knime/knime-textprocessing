...
/**
 * This class creates the node model for the Word Vector Model Writer node.
 *
 * @author Perla Gjoka, KNIME GmbH, Konstanz, Germany
 */
final class WordVectorModelWriter2NodeModel extends PortObjectToFileWriterNodeModel<PortObjectWriterNodeConfig> {

    /**
     * @param creationConfig the node creation confiiguration.
     * @param config the writer configuration.
     */
    protected WordVectorModelWriter2NodeModel(final NodeCreationConfiguration creationConfig,
    ...
    protected void write(final PortObject object, final OutputStream outputStream, final ExecutionContext exec)
        ...
        try (final ZipOutputStream zipOut = new ZipOutputStream(outputStream)) {
            WordVectorPortObjectUtils.writeFileStorePortObject((WordVectorFileStorePortObject)object, zipOut);
        }
    }
}
