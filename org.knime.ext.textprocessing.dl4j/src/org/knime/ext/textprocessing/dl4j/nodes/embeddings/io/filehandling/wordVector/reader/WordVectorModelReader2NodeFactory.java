...
/**
 * Node Factory of the Word Vector Model Reader node.
 *
 * @author Perla Gjoka, KNIME GmbH, Konstanz, Germany
 */
public class WordVectorModelReader2NodeFactory extends
    PortObjectReaderNodeFactory<WordVectorModelReader2NodeModel, PortObjectReaderNodeDialog<PortObjectReaderNodeConfig>> {

    /** File chooser history Id. */
    private static final String HISTORY_ID = "word_vector_reader_writer";
