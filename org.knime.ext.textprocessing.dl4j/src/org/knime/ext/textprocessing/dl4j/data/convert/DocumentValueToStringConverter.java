 ...
 */
public class DocumentValueToStringConverter extends BaseDL4JConverter<DocumentValue, String> {
    /**
     * Constructor for class DocumentValueToStringConverter.
     */
    public DocumentValueToStringConverter() {
        super(DocumentValue.class, String.class, BaseDL4JConverter.DEFAULT_PRIORITY + 500);
    }
